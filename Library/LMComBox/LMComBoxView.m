...
//    btn.layer.borderColor = kBorderColor.CGColor;
    ...
    titleLabel.frame=CGRectMake(20, 0, self.frame.size.width-40, self.frame.size.height);
    
    titleLabel.font = [UIFont systemFontOfSize:14];
    titleLabel.backgroundColor = [UIColor clearColor];
    titleLabel.textAlignment = NSTextAlignmentCenter;
    if(self.titleLabelColor)
    {
    ...
    _arrow = [[UIImageView alloc]initWithFrame:CGRectMake(self.frame.size.width/2+50, (self.frame.size.height-imgH)/2.0, imgW, imgH)];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(cell==nil)
    {
        ...
        //line.backgroundColor = kBorderColor;//[UIColor colorWithRed:239.0/255 green:239.0/255 blue:244.0/255 alpha:1.0]
        
        line.backgroundColor = [UIColor colorWithRed:239.0/255 green:239.0/255 blue:244.0/255 alpha:1.0];
